...
column_stettings = [{'header':column} for column in df.columns]
worksheet.add_table(0,0,max_rows,max_cols-1,{"columns":column_stettings})
worksheet.set_column(0,max_cols-1,12)
